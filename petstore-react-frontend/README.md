...
```bash
git clone https://github.com/anasshatnawi/Energy-Consumption-of-Web-Frontend-Frameworks-An-Empirical-Comparison-of-Angular-and-React/edit/master/petstore-angular-frontend
```
